    ...
    const driverFinancials = useMemo(() => {
        ...
        if (driverRides.length === 0) {
            ...
            return {
                ...
                averageTicket: 0,
                rides: [],
                driverName: driverInfo?.name || 'Desconhecido'
            };
        }
        ...
        return {
            ...
            totalRides,
            averageTicket,
            rides: [...driverRides], // rideHistory is already ordered descending by fetch
            driverName: driverInfo?.name || 'Desconhecido'
        };
    }, [selectedDriverId, rideHistory, drivers, currentDriver]);
        ...
        <div>
            ...
            {!selectedDriverId ? (
                ...
                <div className="text-center py-16 bg-gray-900/50 rounded-lg">
                    ...
                    <p className="text-gray-400">Nenhuma corrida encontrada para o motorista <span className="text-white font-bold">{driverFinancials?.driverName}</span>.</p>
                </div>
            ) : (
                <>
                    {/* Stats Section */}
